...
> **Note on CGF DM%:** The original v1.0 document used 60% DM (wet feed) but applied a dry pellet price ($130/t), which was internally inconsistent. This version uses **dry pellets at 88% DM** with the corresponding dry pellet price, which is the standard traded form for corn gluten feed. If wet feed is used instead, both the DM% and the price must be adjusted accordingly (wet feed: 40–60% DM, $60–80/t).
...
| Co-product | Calculation | Allocation |
|------------|-------------|------------|
| Corn starch | (0.5572 ÷ 0.9203) × 100 | **60.5%** |
...
> The DM balance shows an 8.9% overage (0.9203 t out vs. 0.845 t in). This arises because wet milling adds approximately 30–35% water during steeping. The added water carries dissolved solids (proteins, minerals, organic acids) from the corn kernel into the steep liquor, increasing the total DM output above the corn DM input. The steep liquor DM (0.065 t) represents solubilized corn components. The as-is output sum (1.160 t/t) exceeds the input mass (1.0 t/t) because of the added steep water, which is physically correct.
...
| Co-product | Calculation | Allocation |
|------------|-------------|------------|
| Corn meal & grits | (128.80 ÷ 205.30) × 100 | **62.7%** |
...
| Co-product | Yield (t/t corn) | Range | Source & Calculation |
|------------|-----------------|-------|---------------------|
| **Fuel ethanol** | 0.31 | 0.30–0.32 | farmdoc daily [^5^]: 2.95 gal/bu (2024–25 average). Pure ethanol: 2.95 gal × 6.58 lb/gal = 19.41 lb/bu. Conversion: 19.41 × 0.000453592 ÷ 0.025401 = **0.347 t/t** denatured; pure ethanol ≈ **0.31 t/t**. The 0.31 midpoint is the mathematical midpoint of the stated range. |
...
> **Note on ethanol yield:** The value 0.31 t/t represents **pure (undenatured) ethanol**. Denatured ethanol (with 2–5% gasoline denaturant) weighs ~0.34–0.36 t/t. For LCA and allocation purposes, pure ethanol is the correct basis.
...
|--------|----------------|----------------------|----------------------|-----|
| **Corn wet milling** | Corn starch | 65.6% | 60.5% | 5.1 pp |
| **Corn dry milling** | Corn meal & grits | 62.7% | 57.5% | 5.2 pp |
...
|--------|---------------|-----------------|---------|-------------------|-------|
| Wet milling | 0.845 | 0.9203 | 108.9% | 1.160 | Exceeds input due to steep water carrying dissolved corn solids |
...
- The 8.9% DM overage arises because steep water dissolves corn components (proteins, minerals, organic acids) that are captured in CSL and other products. The steeping process adds ~0.30–0.35 t of water per t corn, and the dissolved solids in CSL (0.065 t DM) and absorbed moisture in CGF contribute to the DM overage.
- As-is mass (1.160 t) exceeds input (1.0 t) because ~0.16 t of water is retained in the co-products (primarily in CSL and wet CGF).
...
- Missing DM: 0.2844 t is converted to CO₂ gas (~0.297 t CO₂/t corn from stoichiometry) and lost as water vapor. The CO₂ estimate slightly exceeds the missing DM because ethanol (0.31 t) is slightly less than the stoichiometric maximum from 0.845 t DM of corn starch.
- This is physically correct for ethanol fermentation.
...
1. **Regional variation:** Prices vary significantly by location (Corn Belt vs. coastal markets). CGF pellet prices vary from $134/t to $234/t depending on region.

2. **Temporal variation:** Prices are volatile. The 2024–2025 average may not represent future markets. Ethanol prices ranged from $1.40 to $2.00/gal over the past several years.

3. **Product form consistency:** Corn gluten feed can be wet (40–60% DM) or dry pellets (88–90% DM). This document uses **dry pellets** at 88% DM with a corresponding dry pellet price. If wet feed is used, both the DM% and price must be adjusted together.

4. **Corn oil yield variability:** Corn oil extraction rates vary significantly by plant technology and vintage. Older plants may extract only 0.3–0.5 lb/bu, while the most advanced plants in late 2025 achieved ~1.0 lb/bu. The midpoint of 0.013 t/t (~0.72 lb/bu) represents a mid-range plant in the 2024–2025 period.

5. **Starch yield interpretation:** The 31.5 lb/bu starch yield from LBNL/DOE [^2^] represents recoverable starch after wet milling losses, not the total starch content of the corn kernel (which is ~60–65% or ~33–36 lb/bu). The difference is accounted for in the gluten meal, gluten feed, and steep liquor fractions.

6. **Germ yield interpretation:** The 7.5% germ yield represents recoverable germ after wet milling, not the total germ content of the corn kernel (which is ~10–12%). The difference is accounted for in other co-product fractions.

7. **CO₂ from ethanol fermentation:** CO₂ is typically vented and excluded from allocation. If a plant captures and sells CO₂ as a co-product (for beverage carbonation, dry ice, or enhanced oil recovery), it should be included as an additional co-product with its own yield, price, and DM content.

8. **Denaturant in fuel ethanol:** The denaturant (2–5% gasoline) adds mass and value to denatured ethanol but is not a corn-derived product. For LCA purposes, pure (undenatured) ethanol is the correct basis, as the denaturant should be allocated to the petroleum system.
...
|-------------|-------------|-------|---------------|-------------------|-------------------|-------------------|-------------|-------------|---------------|-------------|--------|-----------------|-----------------|----------------|----------------|
| Field Corn | Corn wet milling | Single | 56 lb/bu at 15.5% moisture | 15.5% | 1 t corn at 15.5% moisture | Corn starch | 0.56 | 0.54–0.58 | 400 | 350–450 | 99.5 | 0.5572 | 224.00 | 65.6 | 60.5 |
...
| Field Corn | Corn dry milling | Single | — | 15.5% | 1 t corn at 15.5% moisture | Corn meal & grits | 0.56 | 0.54–0.58 | 230 | 200–260 | 89.0 | 0.4984 | 128.80 | 62.7 | 57.5 |
