...
| Cotton | Ginning (Stage 1) | Cotton lint, Whole cottonseed |
| Cotton | Cottonseed Crushing (Stage 2) | Cottonseed oil, Cottonseed meal, Cottonseed hulls, Cottonseed linters |
...
| Net Energy (NE) / Lower Heating Value (LHV) | ME minus heat increment (energy cost of digestion/metabolism); for fuels: GE minus latent heat of water vaporization | Calculation from ME or from elemental analysis (for fuels) | Species-specific (NE for lactation ≠ NE for growth); fuel-specific |
...
Barley is modeled as a 2-stage cascade, consistent with the economic and mass allocation methodology. **Stage 1 (Malting)** allocates between malt (intermediate) and malt sprouts. **Stage 2 (Brewing)** allocates malt's share between beer and brewers spent grain. The following example uses DM outputs from the Barley Processing Methodology document and GE values from this document:

#### Stage 1: Malting (1 t barley at 12% moisture, DM input = 0.880 t)

| Co-product | DM Output (t/t)¹ | GE (MJ/kg DM)² | Energy Output (MJ/t) | Energy Alloc (Stage 1) |
|------------|-------------------|-----------------|----------------------|------------------------|
| Malt | 0.760 | 19.5 | 14,820 | **95.7%** |
| Malt sprouts | 0.036 | 18.4 | 662 | **4.3%** |
| **Total** | **0.796** | — | **15,482** | **100.0%** |

#### Stage 2: Brewing (within malt's 95.7% energy share)

| Co-product | DM Output (t/t malt)¹ | GE (MJ/kg DM)² | Energy Output (MJ/t malt) | Energy Sub-Share (Stage 2) |
|------------|------------------------|-----------------|----------------------------|----------------------------|
| Beer | 0.660 | 20.5 | 13,530 | **79.0%** |
| BSG (dried) | 0.180 | 20.0 | 3,600 | **21.0%** |
| **Total** | **0.840** | — | **17,130** | **100.0%** |

#### Final Cascade Energy Allocation (per t barley)

| Co-product | Calculation | Energy Alloc |
|------------|-------------|--------------|
| Malt sprouts | Stage 1 direct | **4.3%** |
| Beer | 95.7% × 79.0% | **75.6%** |
...
|------------|----------|------|--------|
| Malt sprouts | 3.2% | 4.5% | 4.3% |
| Beer | 95.1% | 75.0% | 75.6% |
| BSG (dried) | 1.6% | 20.5% | 20.1% |

**Interpretation:** For barley, energy allocation nearly equals mass allocation across all three co-products. This is because all three co-products have similar GE per kg DM (18.4–20.5 MJ/kg DM, only a 1.1× ratio), so the energy allocation is dominated by the DM mass distribution. The energy allocation for beer (75.6%) is nearly identical to its mass allocation (75.0%), while its economic allocation (95.1%) is much higher because beer commands a far higher price per tonne than spent grain or sprouts. The cascade structure ensures that malt sprouts receive their fair Stage 1 allocation (4.3% energy) rather than being dwarfed by beer's revenue in a combined single-pool allocation.
...
The National Research Council (NRC) publications provide GE and ME values for common feed ingredients used in the United States.

**Tier 3: Composition-Based Calculation**

For co-products not directly listed in the INRAE-CIRAD-AFZ or NRC tables (e.g., beer, corn steep liquor), GE is calculated from proximate composition using the Atwater system constants:
...
- **NRC (2012)** Nutrient Requirements of Swine, Tables 14-1 through 14-10
...
| 2 | NRC (2012) Nutrient Requirements of Swine, Tables 14-1 through 14-10 | Feed-grade co-products |
...
|---|---|---|---|
| **Soybean (Crushing)** | Soybean oil | 39.3 | NRC 2012 Table 14-5; USDA SR28 04044 |
| | Soybean meal (48%) | 19.7 | NRC 2012 Table 14-5; FAO Feedipedia |
| | Soybean hulls | 18.1 | NRC 2012 Table 14-5 |
| **Canola (Crushing)** | Canola oil | 39.3 | NRC 2012; USDA SR28 04582 |
| | Canola meal | 19.7 | NRC 2012 Table 14-5; Bell 1993 |
| **Flaxseed (Crushing)** | Linseed oil | 39.3 | NRC 2012; USDA SR28 42231 |
| | Linseed meal | 19.5 | NRC 2012; FAO Feedipedia; Sauvant et al. 2004 |
| **Sunflower (Crushing)** | Sunflower oil | 39.3 | NRC 2012; USDA SR28 04506 |
| | Sunflower meal | 19.4 | NRC 2012 Table 14-5; FAO Feedipedia |
| | Sunflower hulls | 20.1 | NRC 2012; FAO Feedipedia |
| **Safflower (Crushing)** | Safflower oil | 39.3 | NRC 2012; USDA SR28 04510 |
| | Safflower meal | 19.0 | NRC 2012; FAO Feedipedia |
| **Wheat (Flour Milling)** | Wheat flour | 18.3 | NRC 2012 Table 14-3; USDA SR28 20081 |
| | Wheat bran | 18.9 | NRC 2012 Table 14-3; FAO Feedipedia |
| | Wheat middlings | 19.2 | NRC 2012 Table 14-3; FAO Feedipedia |
| **Wheat (Dry-Grind Ethanol)** | Fuel ethanol | 29.7 | CRC Handbook (HHV of pure C2H5OH) |
| | Wheat DGS | 20.3 | NRC 2012; Cozannet et al. 2010 |
| **Corn (Wet Milling)** | Corn starch | 17.5 | NRC 2012; USDA SR28 20027 |
| | Corn gluten meal | 23.9 | NRC 2012 Table 14-1; FAO Feedipedia |
| | Corn gluten feed | 18.8 | NRC 2012 Table 14-1; FAO Feedipedia |
| | Corn germ | 28.9 | NRC 2012 Table 14-1; FAO Feedipedia |
| | Corn steep liquor | 17.5 | Calculated from composition; FAO Feedipedia |
| **Corn (Dry Milling)** | Corn meal & grits | 18.6 | NRC 2012; USDA SR28 20020 |
| | Hominy feed | 18.7 | NRC 2012 Table 14-1; FAO Feedipedia |
| | Corn germ (dry) | 28.9 | NRC 2012; FAO Feedipedia |
| **Corn (Dry-Grind Ethanol)** | Fuel ethanol | 29.7 | CRC Handbook (HHV of pure C2H5OH) |
| | DDGS | 21.4 | NRC 2012 Table 14-1; Spiehs et al. 2002 |
| | Corn oil (post-ferm) | 39.3 | NRC 2012; USDA SR28 04518 |
| **Sweet Corn (Canning)** | Edible kernels | 18.3 | NRC 2012; USDA SR28 11167 |
| | Cannery waste silage | 17.5 | NRC 2012; FAO Feedipedia |
| **Oat (Milling)** | Food oats | 19.5 | NRC 2012 Table 14-3; USDA SR28 08120 |
| | Oat hulls | 18.4 | NRC 2012 Table 14-3; FAO Feedipedia |
| | Oat mill feed | 17.5 | NRC 2012 Table 14-3; FAO Feedipedia |
| **Almond (Hulling)** | Almond kernels | 30.7 | USDA SR28 12061; Souci et al. 2008 |
| | Almond hulls | 17.0 | NRC 2012; FAO Feedipedia |
| | Almond shells | 19.5 | NRC 2012; FAO Feedipedia |
| **Potato (Processing)** | Processed potato products | 17.5 | NRC 2012 Table 14-10; USDA SR28 11353 |
| | Potato processing waste | 16.5 | NRC 2012; FAO Feedipedia |
| **Citrus (Processing)** | Citrus juice | 16.5 | NRC 2012; USDA SR28 09206 |
| | Citrus pulp (wet) | 17.6 | NRC 2012 Table 14-9; FAO Feedipedia |
| **Sugar Beet (Processing)** | Refined sugar | 16.5 | CRC Handbook (HHV of sucrose) |
| | Beet pulp (wet) | 17.1 | NRC 2012 Table 14-8; FAO Feedipedia |
| | Beet molasses | 14.5 | NRC 2012 Table 14-8; FAO Feedipedia |
| **Sugarcane (Milling)** | Raw sugar | 16.0 | NRC 2012; FAO Feedipedia; ICUMSA |
| | Cane molasses | 14.7 | NRC 2012; FAO Feedipedia |
| **Cotton (Ginning → Crushing)** | Cotton lint | 17.5 | CRC Handbook (cellulose HHV) |
| | Whole cottonseed | 23.8 | NRC 2012 Table 14-5; FAO Feedipedia |
| | Cottonseed oil | 39.3 | NRC 2012; USDA SR28 04502 |
| | Cottonseed meal | 20.0 | NRC 2012 Table 14-5; FAO Feedipedia |
| | Cottonseed hulls | 19.8 | NRC 2012 Table 14-5; FAO Feedipedia |
| | Cottonseed linters | 17.5 | NBS bomb calorimetry (pure cellulose); CRC Handbook |
| **Rice (Hulling → Milling)** | Brown rice | 18.1 | NRC 2012 Table 14-7; USDA SR28 20036 |
| | Rice hulls | 16.3 | NRC 2012 Table 14-7; FAO Feedipedia |
| | White rice | 18.0 | NRC 2012 Table 14-7; USDA SR28 20444 |
| | Rice bran | 20.5 | NRC 2012 Table 14-7; USDA SR28 20060 |
| | Rice mill feed | 16.5 | NRC 2012 Table 14-7; FAO Feedipedia |
| **Barley (Malting → Brewing)** | Malt | 19.5 | NRC 2012; FAO Feedipedia; Briggs et al. 2004 |
| | Malt sprouts | 18.4 | NRC 2012; FAO Feedipedia |
| | Beer | 20.5 | USDA SR28 14003; HHV correction for ethanol (calculated) |
| | Brewers spent grain | 20.0 | NRC 2012; FAO Feedipedia; Mussatto et al. 2006 |
| **Peanut (Shelling → Crushing)** | Shelled kernels | 29.3 | USDA SR28 16087; FAO Feedipedia |
| | Peanut hulls | 19.8 | NRC 2012; FAO Feedipedia |
| | Peanut oil | 39.3 | NRC 2012; USDA SR28 04042 |
| | Peanut meal | 20.0 | NRC 2012; FAO Feedipedia; Sauvant et al. 2004 |
...
The energy coefficients are from NRC (2012) Chapter 8, ECOINVENT v3 documentation, and ISO 9831:1998.
...
**Citation basis**: FAO Feedipedia, Corn gluten meal, bomb calorimetry values; NRC (2012) Table 14-1.
...
**Citation basis**: FAO Feedipedia, Beet molasses, n=8 bomb calorimetry studies; NRC (2012) Table 14-8.
...
The full composition dataset (CP, CF, CHO, CFiber with min/mid/max for each product) is documented in the companion script `GE-Range-Uncertainty.py`, which can be run to calculate GE_lo and GE_hi for all products. The script also applies all PERT-validity corrections automatically and verifies that all products pass the PERT validity check (GE_lo ≤ GE_lit ≤ GE_hi).
...
GE = **20.5 MJ/kg DM**, range (19.0, 22.0).

Beer contains approximately 4–5% alcohol by volume (ABV), which corresponds to roughly 3.1–3.9% ethanol by weight. The standard proximate composition formula treats all non-CP/CF/CFiber material as carbohydrate at 17.5 MJ/kg, which significantly underestimates the energy content of ethanol (29.7 MJ/kg).

Beer's GE on a DM basis is calculated using an ethanol HHV correction:

GE_DM = [(ethanol_wt% × 29.7) + (residual_solids_DM_fraction × 17.5)] / DM_fraction

With ~4% ABV ≈ 3.1% w/w ethanol and ~12% DM, the effective GE is approximately 20.5 MJ/kg DM. This value is used directly rather than derived from the proximate composition formula. The range (19.0–22.0) reflects variation in ABV (4–6%) and residual sugar content.

> **Note on beer GE:** Beer is unique among the co-products in this review because it contains a significant fraction of ethanol (~33% of DM at 5% ABV). Ethanol has a GE of 29.7 MJ/kg DM, which is substantially higher than carbohydrates (16.5 MJ/kg) but lower than fat (39.3 MJ/kg). This gives beer DM an elevated GE of ~20.5 MJ/kg DM, higher than the barley from which it was derived (~18.4 MJ/kg).
...
| Almond shells | 19.5 | 13.8–22.4 | Research literature (~20 MJ/kg) | Medium |
...
> **Note on brown rice (intermediate):** Brown rice is the intermediate product of the rice hulling stage, comprising the inner white rice, bran, and germ layers with the hull removed. It is not a traded commodity with published GE data. Its GE (18.1 MJ/kg DM) is derived as the DM-weighted average of its constituent milled products: white rice (18.0 MJ/kg DM, 84.4% of brown rice DM), rice bran (20.5 MJ/kg DM, 9.1%), and rice mill feed (16.5 MJ/kg DM, 6.5%). This derivation ensures mass-energy consistency across the two-stage cascade: the total energy of brown rice equals the sum of energies of its milled products. This GE value is used only for Stage 1 energy allocation in the rice cascade.

> **Note on malt (intermediate):** Malt is the intermediate product of the barley malting stage, produced by steeping, germinating, and kilning barley grain. It is not typically listed in feed GE tables as a standalone ingredient. Its GE (19.5 MJ/kg DM) is estimated from the parent barley grain GE (~19.5 MJ/kg DM from INRAE-CIRAD-AFZ), as malting does not significantly alter the total energy content: the germination process converts some starch to sugars and produces CO₂ and water vapor, but the remaining DM retains essentially the same caloric value per unit mass. The 9.5% DM loss during malting (to respiration) reduces total DM output but not the GE per kg of remaining DM. This GE value is used only for Stage 1 energy allocation in the barley cascade. The half-mirror correction extends GE_hi to 20.4 (Section 7.5.1b).
...
| Beer (5% ABV, ~12% DM) | 20.5 | 19.0–22.0 | Calculated from composition | Medium |
| Maize DDGS | 21.4 | 17.2–22.3 | Feedipedia (n=32) / INRAE-CIRAD-AFZ (n=42) | High |
...
> **Note on peanut seeds / shelled kernels (intermediate):** Shelled peanut kernels are the intermediate product of the peanut shelling stage (Stage 1), produced by removing the hulls from in-shell peanuts. They are also the input to the crushing stage (Stage 2), where they are processed into peanut oil and peanut meal. Their GE (29.3 MJ/kg DM) is the Feedipedia measured value for whole peanut seeds (n ≥ 6, bomb calorimetry). This high GE reflects the kernels' ~47% oil content (fat GE = 39.3 MJ/kg). A derivation from the DM-weighted average of Stage 2 products — (0.4500 × 39.3 + 0.4400 × 20.0) / 0.8900 = 29.8 MJ/kg DM — confirms consistency within 1.7% (the small difference is attributable to ~3.3% processing losses in Stage 2). This GE value is used for Stage 1 energy allocation in the peanut cascade, analogous to brown rice in the rice cascade and whole cottonseed in the cotton cascade.

> **Note on whole cottonseed (intermediate):** Whole cottonseed is the intermediate product of the cotton ginning stage (Stage 1), containing the kernel, hull, and linters. Its GE (23.8 MJ/kg DM from INRAE-CIRAD-AFZ) reflects its ~18–22% oil content, which is lower than peanut kernels (~47%) and almond kernels (~50%) but still substantially higher than hulls and meals. This GE value is used for Stage 1 energy allocation in the cotton cascade.
...
| Potato processing waste | 16.5 | 14.9–18.5 | Estimated (higher ash than main product) | Medium |
...
| | Malt sprouts | 18.4 | 16.1–20.0 | INRAE-CIRAD-AFZ / Feedipedia | High |
| **Barley – Stage 2: Brewing** | Beer | 20.5 | 19.0–22.0 | Calculated from composition | Medium |
| | Brewers spent grain (dried) | 20.0 | 16.2–21.6 | INRAE-CIRAD-AFZ / Feedipedia | High |
...
> **Note on cotton cascade:** Cotton is modeled as a 2-stage cascade, consistent with the economic and mass allocation methodology. **Stage 1 (Ginning):** Seed cotton is separated into cotton lint and whole cottonseed (GE = 23.8 MJ/kg DM from INRAE-CIRAD-AFZ). **Stage 2 (Cottonseed Crushing):** Whole cottonseed is processed into oil, meal, hulls, and linters. The energy allocation for each final cottonseed product is calculated as: Stage 1 energy allocation (whole cottonseed) × Stage 2 energy sub-share (individual product). The DM outputs for both stages come from the cotton methodology document.
...
> **Note on peanut cascade:** Peanut is modeled as a 2-stage cascade, consistent with the economic and mass allocation methodology. **Stage 1 (Shelling):** In-shell peanuts are separated into shelled kernels (intermediate, GE = 29.3 MJ/kg DM from Feedipedia) and peanut hulls. **Stage 2 (Crushing):** Shelled kernels are processed into peanut oil and peanut meal. The energy allocation for each final product is calculated as: Stage 1 energy allocation (shelled kernels) × Stage 2 energy sub-share (individual product). The shelled kernels GE (29.3 MJ/kg DM) is the Feedipedia measured value for whole peanut seeds; a derivation from the DM-weighted average of Stage 2 products (peanut oil at 39.3 MJ/kg DM and peanut meal at 20.0 MJ/kg DM) gives 29.8 MJ/kg DM, confirming consistency within 1.7%. The DM outputs for both stages come from the peanut methodology document.

> **General cascade principle:** When a crop has a 2-stage process, the cascade structure reflects the physical processing chain, not the allocation basis. Energy allocation must use the same cascade structure as economic and mass allocation for consistency. The formula is identical across all three methods: Final_Alloc_i = Stage1_Alloc_intermediate × Stage2_SubShare_i. Using a single-pool allocation for energy while using cascade for economic/mass would violate the physical process boundary and produce inconsistent results. Four crops use 2-stage cascade allocation: **cotton** (ginning → cottonseed crushing), **rice** (hulling → milling), **barley** (malting → brewing), and **peanut** (shelling → crushing).
...
| 1 | Soybean oil | 38.5 | 39.3 | 40.0 | 1.5 | Override | NRC 2012; USDA SR28 04044; ECOINVENT v3.9 |
| 2 | Canola oil | 38.5 | 39.3 | 40.0 | 1.5 | Override | NRC 2012; USDA SR28 04582; ECOINVENT v3.9 |
| 3 | Linseed oil | 38.5 | 39.3 | 40.0 | 1.5 | Override | NRC 2012; USDA SR28 42231; ECOINVENT v3.9 |
| 4 | Sunflower oil | 38.5 | 39.3 | 40.0 | 1.5 | Override | NRC 2012; USDA SR28 04506; ECOINVENT v3.9 |
| 5 | Safflower oil | 38.5 | 39.3 | 40.0 | 1.5 | Override | NRC 2012; USDA SR28 04510; ECOINVENT v3.9 |
| 6 | Cottonseed oil | 38.5 | 39.3 | 40.0 | 1.5 | Override | NRC 2012; USDA SR28 04502; ECOINVENT v3.9 |
| 7 | Peanut oil | 38.5 | 39.3 | 40.0 | 1.5 | Override | NRC 2012; USDA SR28 04042; ECOINVENT v3.9 |
| 8 | Corn oil (post-ferm) | 38.5 | 39.3 | 40.0 | 1.5 | Override | NRC 2012; USDA SR28 04518; ECOINVENT v3.9 |
| **Pure Substances (Override)** |||||||||
| 9 | Fuel ethanol | 29.7 | 29.7 | 29.7 | 0.0 | Override (constant) | CRC Handbook (HHV of pure ethanol) |
| 10 | Refined sugar | 16.4 | 16.5 | 16.6 | 0.2 | Override | CRC Handbook (HHV of sucrose) |
| **Protein Meals** |||||||||
| 11 | Soybean meal (48%) | 16.3 | 19.7 | 20.2 | 3.9 | Comp-derived | NRC 2012; FAO Feedipedia; Sauvant et al. 2004 |
| 12 | Canola meal | 16.1 | 19.7 | 21.2 | 5.1 | Comp-derived | NRC 2012; FAO Feedipedia; Bell 1993 |
| 13 | Linseed meal | 15.9 | 19.5 | 22.8 | 6.9 | Comp-derived | NRC 2012; FAO Feedipedia; Sauvant et al. 2004 |
| 14 | Sunflower meal | 14.3 | 19.4 | 21.8 | 7.5 | Comp-derived | NRC 2012; FAO Feedipedia |
| 15 | Safflower meal | 14.7 | 19.0 | 20.9 | 6.2 | Comp-derived | NRC 2012; FAO Feedipedia |
| 16 | Cottonseed meal | 15.8 | 20.0 | 20.2 | 4.4 | Comp-derived | NRC 2012; FAO Feedipedia |
| 17 | Peanut meal | 17.2 | 20.0 | 21.4 | 4.2 | **Half-mirror (7.5.1b)** | NRC 2012; FAO Feedipedia; Sauvant et al. 2004 |
| 18 | DDGS (corn) | 17.2 | 21.4 | 22.3 | 5.1 | Comp-derived | NRC 2012; Spiehs et al. 2002; FAO Feedipedia |
| 19 | Wheat DGS | 16.1 | 20.3 | 21.2 | 5.1 | Comp-derived | NRC 2012; Cozannet et al. 2010 |
| 20 | Brewers spent grain (dried) | 16.2 | 20.0 | 21.6 | 5.4 | Comp-derived | NRC 2012; FAO Feedipedia; Mussatto et al. 2006 |
| **Bran / Germ Products** |||||||||
| 21 | Wheat bran | 15.9 | 18.9 | 20.1 | 4.2 | Comp-derived | NRC 2012; FAO Feedipedia; USDA SR28 20077 |
| 22 | Rice bran | 17.3 | 20.5 | 23.4 | 6.1 | Comp-derived | NRC 2012; FAO Feedipedia; USDA SR28 20060 |
| 23 | Corn germ | 22.9 | 28.9 | 29.5 | 6.6 | Comp-derived | NRC 2012; FAO Feedipedia; ECOINVENT v3.9 |
| **High-Fat Products** |||||||||
| 24 | Whole cottonseed | 19.8 | 23.8 | 25.2 | 5.4 | Comp-derived | NRC 2012; FAO Feedipedia |
| 25 | Peanut kernels | 25.9 | 29.3 | 31.0 | 5.1 | Comp-derived | USDA SR28 16087; FAO Feedipedia |
| 26 | Almond kernels | 26.8 | 30.7 | 32.6 | 5.8 | Comp-derived | USDA SR28 12061; Souci et al. 2008 |
| 27 | Cotton lint | 14.9 | 17.5 | 18.6 | 3.7 | Comp-derived | CRC Handbook (cellulose HHV) |
| **Starch / Carbohydrate Products** |||||||||
| 28 | Corn starch | 17.3 | 17.5 | 17.7 | 0.4 | Comp-derived | NRC 2012; USDA SR28 20027; ECOINVENT v3.9 |
| 29 | Wheat flour | 17.0 | 18.3 | 18.7 | 1.7 | Comp-derived | NRC 2012; USDA SR28 20081; ECOINVENT v3.9 |
| 30 | White rice | 17.0 | 18.0 | 18.4 | 1.4 | Comp-derived | NRC 2012; USDA SR28 20444; FAO Feedipedia |
| 31 | Brown rice | 17.0 | 18.1 | 18.8 | 1.8 | Comp-derived | NRC 2012; USDA SR28 20036; FAO Feedipedia |
| 32 | Corn meal & grits | 16.9 | 18.6 | 18.7 | 1.8 | Comp-derived | NRC 2012; USDA SR28 20020; FAO Feedipedia |
| 33 | Raw sugar | 15.5 | 16.0 | 17.1 | 1.6 | **Impurity** | NRC 2012; FAO Feedipedia; ICUMSA |
| 34 | Malt | 17.6 | 19.5 | 20.4 | 2.8 | **Half-mirror (7.5.1b)** | NRC 2012; FAO Feedipedia; Briggs et al. 2004 |
| 35 | Food oats | 16.6 | 19.5 | 20.6 | 4.0 | Comp-derived | NRC 2012; USDA SR28 08120; FAO Feedipedia |
| 36 | Sweet corn kernels | 16.9 | 18.3 | 18.6 | 1.7 | Comp-derived | NRC 2012; USDA SR28 11167; FAO Feedipedia |
| **Fibrous Byproducts** |||||||||
| 37 | Soybean hulls | 15.4 | 18.1 | 19.9 | 4.5 | Comp-derived | NRC 2012; FAO Feedipedia |
| 38 | Sunflower hulls | 14.5 | 20.1 | 22.9 | 8.4 | **Half-mirror (7.5.1a)** | NRC 2012; FAO Feedipedia |
| 39 | Cottonseed hulls | 14.5 | 19.8 | 22.5 | 8.0 | **Half-mirror (7.5.1a)** | NRC 2012; FAO Feedipedia |
| 40 | Cottonseed linters | 15.9 | 17.5 | 18.2 | 2.3 | Comp-derived | NBS bomb calorimetry (pure cellulose); CRC Handbook |
| 41 | Rice hulls | 13.8 | 16.3 | 18.2 | 4.4 | Comp-derived | NRC 2012; FAO Feedipedia; ECOINVENT v3.9 |
| 42 | Peanut hulls | 13.6 | 19.8 | 21.5 | 7.9 | **Half-mirror (7.5.1a) + cap** | NRC 2012; FAO Feedipedia |
| 43 | Oat hulls | 14.5 | 18.4 | 19.2 | 4.7 | Comp-derived | NRC 2012; FAO Feedipedia |
| 44 | Almond hulls | 14.5 | 17.0 | 18.8 | 4.3 | Comp-derived | Estimated from composition; FAO Feedipedia |
| 45 | Almond shells | 13.8 | 19.5 | 22.4 | 8.6 | **Half-mirror (7.5.1a)** | NRC 2012; ECOINVENT v3.9 |
| **Mixed Byproducts** |||||||||
| 46 | Corn gluten feed | 14.8 | 18.8 | 19.1 | 4.3 | **Minimal buffer** | NRC 2012; FAO Feedipedia; ECOINVENT v3.9 |
| 47 | Corn gluten meal | 22.4 | 23.9 | 25.1 | 2.7 | **Literature-anchored** | NRC 2012; FAO Feedipedia; ECOINVENT v3.9 |
| 48 | Corn steep liquor | 17.1 | 17.5 | 19.0 | 1.9 | **Formula overestimate** | Calculated from composition; FAO Feedipedia |
| 49 | Hominy feed | 14.1 | 18.7 | 19.0 | 4.9 | Comp-derived | NRC 2012; FAO Feedipedia; USDA SR28 20013 |
| 50 | Wheat middlings | 15.8 | 19.2 | 19.6 | 3.8 | Comp-derived | NRC 2012; FAO Feedipedia |
| 51 | Oat mill feed | 14.4 | 17.5 | 18.9 | 4.5 | Comp-derived | NRC 2012; FAO Feedipedia |
| 52 | Malt sprouts | 16.1 | 18.4 | 20.0 | 3.9 | Comp-derived | NRC 2012; FAO Feedipedia; Briggs et al. 2004 |
| 53 | Rice mill feed | 14.4 | 16.5 | 19.8 | 5.4 | Comp-derived | NRC 2012; FAO Feedipedia |
| **Wet / Low-DM Products** |||||||||
| 54 | Beet pulp (wet) | 14.9 | 17.1 | 18.6 | 3.7 | Comp-derived | NRC 2012; FAO Feedipedia; ECOINVENT v3.9 |
| 55 | Beet molasses | 13.9 | 14.5 | 15.5 | 1.6 | **Literature cap** | NRC 2012; FAO Feedipedia |
| 56 | Cane molasses | 13.7 | 14.7 | 15.5 | 1.8 | Comp-derived | NRC 2012; FAO Feedipedia; ECOINVENT v3.9 |
| 57 | Citrus juice | 15.9 | 16.5 | 17.9 | 2.0 | Comp-derived | NRC 2012; USDA SR28 09206; FAO Feedipedia |
| 58 | Citrus pulp (wet) | 13.6 | 17.6 | 18.0 | 4.4 | **Minimal extension** | NRC 2012; FAO Feedipedia; ECOINVENT v3.9 |
| 59 | Cannery waste silage | 13.5 | 17.5 | 18.1 | 4.6 | Comp-derived | Estimated from composition; FAO Feedipedia |
| 60 | Potato products | 16.0 | 17.5 | 18.5 | 2.5 | Comp-derived | NRC 2012; USDA SR28 11353; FAO Feedipedia |
| 61 | Potato waste | 14.9 | 16.5 | 18.5 | 3.6 | Comp-derived | NRC 2012; FAO Feedipedia; ECOINVENT v3.9 |
| 62 | Beer | 19.0 | 20.5 | 22.0 | 3.0 | Override | USDA SR28 14003; HHV correction for ethanol (calculated) |
...
The PERT distribution is sampled 10,000 times per Monte Carlo iteration. GE is one of three uncertain parameters (along with yield and price), and all three are varied simultaneously.
